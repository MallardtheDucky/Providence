            ...
            theme: {
                extend: {
                    ...
                    backgroundImage: {
                        ...
                        'continuity-spire': "linear-gradient(to right, rgba(0,0,0,0.85), rgba(0,0,0,0.35)), url('https://commons.wikimedia.org/wiki/Special:FilePath/Stratosphere_Hotel_Las_Vegas.jpg?width=2400')",
