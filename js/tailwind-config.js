            ...
            theme: {
                extend: {
                    ...
                    backgroundImage: {
                        ...
                        'continuity-spire': "linear-gradient(to right, rgba(0,0,0,0.85), rgba(0,0,0,0.35)), url('https://commons.wikimedia.org/wiki/Special:FilePath/Las_Vegas_Strip_Seen_From_Desert_Night.jpg?width=2400')",
